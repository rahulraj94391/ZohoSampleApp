...
object OrdersTable {
    ...
    const val createTableStmt = "CREATE TABLE IF NOT EXISTS $ORDERS_TABLE_NAME ($COL_UID INTEGER, $COL_PID INTEGER, $COL_QUANTITY INTEGER, $COL_DELIVERY_STATUS BOOLEAN, $COL_DELIVERY_DATE INTEGER, $COL_ADDRESS_ID INTEGER, $COL_ORDER_DATE INTEGER, $COL_PAID_THROUGH TEXT)"
}